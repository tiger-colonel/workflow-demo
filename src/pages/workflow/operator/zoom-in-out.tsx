    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <TipPopup title="缩小" shortcuts={['ctrl', '-']}>
              <div
                className="flex items-center justify-center w-8 h-8 rounded-lg cursor-pointer hover:bg-[rgba(0,0,0,.05)]"
                onClick={(e) => {
                  e.stopPropagation();
                  zoomOut();
                }}
              >
                <ZoomOutOutlined className="w-4 h-4" />
              </div>
            </TipPopup>
            <div className="w-[34px]">
              {parseFloat(`${zoom * 100}`).toFixed(0)}%
            </div>
            <TipPopup title="放大" shortcuts={['ctrl', '+']}>
              <div
                className="flex items-center justify-center w-8 h-8 rounded-lg cursor-pointer hover:bg-[rgba(0,0,0,.05)]"
                onClick={(e) => {
                  e.stopPropagation();
              ...
              >
                <ZoomInOutlined className="w-4 h-4" />
              </div>
            </TipPopup>
          </div>
        </div>
